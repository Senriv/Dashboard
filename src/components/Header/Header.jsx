        ...
        <div className="header__inner">
          ...
          <nav className="header__nav">
            <ul className="header__nav-list">
              ...
              <li className="header__nav-item">
                <NavLink className="header__nav-link" to="/product">
                  <Icon
              ...
              <li className="header__nav-item">
                <NavLink className="header__nav-link" to="/customers">
                  <Icon
              ...
              <li className="header__nav-item">
                <NavLink className="header__nav-link" to="/income">
                  <Icon
              ...
              <li className="header__nav-item">
                <NavLink className="header__nav-link" to="/promote">
                  <Icon
